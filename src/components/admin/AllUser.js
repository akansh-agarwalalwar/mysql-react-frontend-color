...
export default function AllUsers() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(
        "https://api.perfectorse.ste/api/v1/admin/all-users"
      );
  ...
  const fetchRechargeHistory = async (userId) => {
    try {
      const response = await fetch(
        `https://api.perfectorse.ste/api/v1/financial/recharge-history?userId=${userId}`
      );
      if (!response.ok) {
  ...
  const fetchWithdrawHistory = async (userId) => {
    try {
      const response = await fetch(
        `https://api.perfectorse.ste/api/v1/financial/withdraw-history?userId=${userId}`
      );
      if (!response.ok) {
        throw new Error(`https error! status: ${response?.status}`);
      }
  ...
  const fetchBankDetails = async (userId) => {
    try {
      const res = await fetch(
        `https://api.perfectorse.ste/api/v1/admin/bank?userId=${userId}`
      );
      if (!res.ok) {
    ...
    if (confirmCreate) {
      try {
        ...
        const response = await axios.post(
          `https://api.perfectorse.ste/api/v1/admin/deleteUser/${userId}`
        );
  ...
  const editUser = async (userId) => {
    try {
      ...
      const response = await axios.post(
        `https://api.perfectorse.ste/api/v1/admin/editUser/${userId}`
      );
      console.log(response.data.message); // Log the response message
    } catch (error) {
      console.error(
