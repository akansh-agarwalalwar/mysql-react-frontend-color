...
export default function ToPay() {
  ...
  const fetchWithdrawHistory = async () => {
    try {
      const response = await axios.get('https://mysql-color-backend-1.onrender.com/api/withdrawl/history');
  ...
  const fetchProcessedWithdrawHistory = async () => {
    try {
      const response = await axios.get('https://mysql-color-backend-1.onrender.com/api/withdrawl/processed-history');
  ...
  const handleAccept = async (id) => {
    try {
      await axios.post('https://mysql-color-backend-1.onrender.com/api/withdrawals/accept', { id });
  ...
  const handleDeny = async (id) => {
    try {
      await axios.post('https://mysql-color-backend-1.onrender.com/api/withdrawals/deny', { id });
