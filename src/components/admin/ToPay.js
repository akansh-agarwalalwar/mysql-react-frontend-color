...
export default function ToPay() {
  ...
  const fetchWithdrawHistory = async () => {
    try {
      const response = await axios.get('https://color-server.onrender.com/api/withdrawl/history');
  ...
  const fetchProcessedWithdrawHistory = async () => {
    try {
      const response = await axios.get('https://color-server.onrender.com/api/withdrawl/processed-history');
  ...
  const handleAccept = async (id) => {
    try {
      await axios.post('https://color-server.onrender.com/api/withdrawals/accept', { id });
  ...
  const handleDeny = async (id) => {
    try {
      await axios.post('https://color-server.onrender.com/api/withdrawals/deny', { id });
