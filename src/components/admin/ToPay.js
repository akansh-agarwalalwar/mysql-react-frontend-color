...
export default function ToPay() {
  ...
  const fetchWithdrawHistory = async () => {
    try {
      const response = await axios.get('http://api.perfectorse.site/api/withdrawl/history');
  ...
  const fetchProcessedWithdrawHistory = async () => {
    try {
      const response = await axios.get('http://api.perfectorse.site/api/withdrawl/processed-history');
  ...
  const handleAccept = async (id) => {
    try {
      await axios.post('http://api.perfectorse.site/api/withdrawals/accept', { id });
  ...
  const handleDeny = async (id) => {
    try {
      await axios.post('http://api.perfectorse.site/api/withdrawals/deny', { id });
