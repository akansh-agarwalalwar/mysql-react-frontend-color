  ...
  return (
    <div className="flex flex-col justify-between mt-5 px-2 overflow-y-auto overflow-scroll pb-8 ">
      <div className="flex flex-row">
        <div className="w-full mr-2">
          <Link to="/home/thirty-second-page">
            <div className="flex flex-col bg-white h-40 rounded-lg border-2 border-myblue-200 relative overflow-hidden shadow-lg shadow-myblue-200">
      ...
      <div className="flex flex-row mt-4 pb-9">
        <div className="w-full mr-2">
          <Link>
          <div className="flex flex-col backdrop-blur-sm bg-white h-40 rounded-lg border-2 border-myblue-200 relative overflow-hidden shadow-lg shadow-myblue-200 justify-center">
              <img
                src={upcomingOne}
                className="object-cover w-full h-full"
                alt="Fast Parity"
