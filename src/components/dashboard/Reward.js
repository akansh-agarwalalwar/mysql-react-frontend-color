...
export default function Reward() {
  return (
    <div className='flex justify-evenly mt-4 max-w-md mx-auto'>
      ...
      <Link to='/daily-bonus'>
      <div className="bg-white text-richblack-700 px-4 py-2 font-semibold rounded-xl flex flex-row justify-center items-center w-full border-2  border-myblue-200">
        <div>
