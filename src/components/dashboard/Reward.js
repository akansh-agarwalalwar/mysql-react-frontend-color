...
export default function Reward() {
  return (
    <div className='flex justify-evenly mt-4'>
      ...
      <Link to='/home/daily-bonus'>
      <div className="bg-white text-richblack-700 px-4 py-2 shadow-xl font-semibold rounded-xl flex flex-row justify-center items-center w-full border-2  border-myblue-200">
        <div>
